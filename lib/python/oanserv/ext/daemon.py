...
Note: this is straight out of the Python cookbook.
"""

__author__ = "Chad J. Schroeder" # (Original author; this is modified by us.)
__version__ = "$Id: daemon.py,v 1.4 2005/04/19 04:35:35 blais Exp $"
